...
#define OTD_TYPES_H
 ...
 #define OTD_FLOAT_TYPE   0xC000 //Float type always signed
...
#define OTD_FA_ANALOG1       0x02 /* Аналоговый параметр1      */
...
#define OTD_FA_ISSETUP(x)     ((x!= OTD_ADDR_MAXVALUE) && (x&OTD_FA_SETUP))
