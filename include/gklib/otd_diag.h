...
#define OTD_STATE_RESERV6              0x00000004
#define OTD_STATE_TUTR_ACTIVE          0x00000002 /*Проводятся операции  ТУ/ТР*/
#define OTD_STATE_TUTR_PREPARE         0x00000001 /*Подготовка операции  ТУ/ТР*/

#define OTD_STATE_TUTR_MASK           (OTD_STATE_TUTR_ACTIVE|OTD_STATE_TUTR_PREPARE)
...
#define OTD_PDIAG_TUTR_ERROR           0x10    /*Неуспешное ТУ/ТР */
#define OTD_PDIAG_TUTR_DESCRIPT        0x08
/*Состояние   параметров*/
#define OTD_PSTATE_RESERV2             0x40
#define OTD_PSTATE_TUTR_ACTIVE         0x02    /*Команда ТУ/ТР активна отправлена*/
#define OTD_PSTATE_TUTR_PREPARE        0x01    /*Подготовка ТУТР*/


#define OTD_PSTATE_MASK                0x03 /*Маска персонального состояния*/
#define OTD_PDIAG_MASK                (~(OTD_PSTATE_MASK|OTD_PDIAG_TUTR_ERROR|OTD_PDIAG_TUTR_DESCRIPT)) /*Маска персональной диагностики*/
...
typedef union _otd_diag
{
  ...
  struct{
         ...
         BYTE    ds_tutr_active :1;//OTD_DIAG_STATE_TUTR_ACTIVE
         BYTE    ds_reserv1_5   :5;//OTD_DIAG_STATE_RESERV1-OTD_DIAG_STATE_RESERV5
